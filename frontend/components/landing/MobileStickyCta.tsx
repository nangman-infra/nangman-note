...
export function MobileStickyCta() {
  ...
  return (
    <div className="fixed inset-x-0 bottom-0 z-40 border-t border-[var(--line-soft)] p-3 sm:hidden" style={{ background: 'rgba(244, 240, 230, 0.92)', backdropFilter: 'blur(16px)', WebkitBackdropFilter: 'blur(16px)' }}>
      <Link
        href="/landing/start"
        className="btn-neo inline-flex flex w-full items-center justify-center gap-2 border-transparent bg-[var(--surface-container)] py-3 text-sm font-medium text-white hover:bg-[var(--surface-container-high)] hover:text-white"
        style={{ color: '#ffffff' }}
      >
        무료로 시작하기
