    ...
    <div className="surface-card overflow-hidden text-[11px]">
      ...
      <header className="space-y-2 px-3 pb-3 pt-3">
        ...
        <div className="flex items-center gap-1.5">
          <span className="rounded-full bg-[var(--tertiary-fixed)] px-1.5 py-0.5 text-[8px] font-medium uppercase tracking-widest text-[var(--tertiary)]">
            Finished
          </span>
      ...
      <div className="grid grid-cols-12 gap-2 p-3">
        ...
        <div className="col-span-8">
          <div className="mb-1 flex items-center gap-1 text-[8px] font-medium uppercase tracking-wider text-[var(--tertiary)]">
          ...
          <article className="ai-card-accent rounded-r-lg p-2.5">
            ...
            <p className="mt-1.5 text-[10px] font-medium text-slate-900">
              2. API 응답 속도 개선
            </p>
            <p className="mt-0.5 text-[9px] leading-snug text-[var(--ink-subtle)]">
              Redis 캐시 레이어 도입에 합의.
