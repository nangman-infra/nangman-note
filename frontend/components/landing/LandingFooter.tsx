      ...
      <div className="mx-auto max-w-6xl px-5 py-10">
        <div className="flex flex-col items-center gap-6 sm:flex-row sm:justify-between">
          <div className="flex items-center gap-3">
            <span className="inline-flex items-center gap-1.5 rounded-full border border-[var(--line-soft)] bg-card/80 px-2.5 py-1 font-headline text-xs font-medium text-electric">
              <Sparkles className="h-3.5 w-3.5" />
              TransNote
            </span>
            <div>
              <p className="font-headline text-sm font-medium">TransNote</p>
