...
const termsSections: LegalDocumentSection[] = [
  ...
  },
  {
    ...
    children: (
      <>
        <p>
          사용자는 낭만 인프라의 Authentik 조직 계정 로그인을 통해 TransNote에
          접속할 수 있습니다. 사용자 식별자, 이메일, 프로필 정보와 인증 세션은
          로그인 처리, 계정 식별, 접근 권한 확인에 사용됩니다.
        </p>
        <p>
          사용자는 본인이 접근 권한을 가진 조직 계정을 사용해야 합니다. 다른
          사람의 계정이나 인증 정보를 무단으로 사용해서는 안 됩니다.
        </p>
      </>
    ),
  },
