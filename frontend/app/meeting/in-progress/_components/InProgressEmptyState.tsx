...
export function InProgressEmptyState({
  ...
  if (isRecoveringMeeting) {
    return (
      <div className="flex h-screen items-center justify-center bg-[var(--bg-root)] p-6">
        <div className="surface-product w-full max-w-xl p-8 text-center">
          <h1 className="font-headline text-2xl">회의 상태를 복구하는 중입니다</h1>
  ...
  return (
    <div className="flex h-screen items-center justify-center p-6">
      <div className="surface-product w-full max-w-xl p-8 text-center">
        <h1 className="font-headline text-2xl">진행 중인 회의가 없습니다</h1>
